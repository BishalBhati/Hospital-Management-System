...
public class chooseDoctor extends javax.swing.JFrame {
    ...
    public chooseDoctor() {
        ...
        Object columns[] = {"ID", "Joining Date","Name", "Age", "Gender", "Blood Group", "Department", "Phone Number", "Email Address", "Status", "Address", "Room number", "Username"};
    ...
    private void initComponents() {
        ...
        dASearchbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select count,date,name,age,gender,blood,dept,phone,email,status,address,room,username from doctor where dept = '" + searchKey + "'";
        try {
