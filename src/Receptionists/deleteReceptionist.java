...
public class deleteReceptionist extends javax.swing.JFrame {
    ...
    public deleteReceptionist() {
        ...
        Object columns[] = {"ID", "Joining Date","Name", "Age", "Gender", "Blood Group", "Email", "Phone Number", "Address", "Status", "Username"};
    ...
    public void loadData() {
        ...
        String sql = "select count,joining,name,age,gender,blood,email,phone,address,status,username,password from receptionist";
        try {
    ...
    private void initComponents() {
        ...
        rDeletebtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
